...
public enum RegisterErrorCode {
    ...
    CONFIRM_PASSWORD_BLANK(1015,"ConfirmPassword must not be blank"),
    CONFIRM_PASSWORD_NOT_MATCHING(1016, "Passwords do not match."),
    USER_NOT_EXISTED(1017,"user is not existed"),
    UNAUTHENTICATED(1018, "unauthenticated")
    ;
    int code;
    String message;
